  ...
  dashboardSidebar(
   ...
   dashboardBody(
     ...
     tabItems(
       ...
       tabItem(tabName = "Netflix",
               ...
               fluidPage(
                 ...
                 div(style = "text-align:justify",
                     ...
                     p(tags$b("Aplikasi hiburan"), "adalah salah satu hal yang harus ada didalam smartphone 
                     ...
                     p(tags$b("Netflix"), "adalah layanan streaming yang menawarkan berbagai acara TV pemenang 
                     ...
                     p("Oleh karena itu, Saya ingin menunjukkan bagaimana setiap kontent di kedua platform 
       ...
       tabItem(tabName = "Spotify",
               fluidPage(
                 h2(tags$b("🎵 Spotify 🎵")),
                 div(style = "text-align:justify",
                     p("Selain di insdustri per-film-an, juga Musik selalu mengambil bagian besar dari kehidupan kita sehari-hari, 
                       ...
                       Saat ini, ", tags$b("Spotify"), "sendiri - sebagai layanan langganan streaming audio terpopuler di dunia

                       ", tags$b("Spotify"), " adalah layanan streaming musik digital. Spotify mengubah mendengarkan musik selamanya ketika 
